...
Come soluzione è stato utilizzato come stream direttamente il WiFiClient utilizzato dalla connessione, che però non sempre presenta
 un output "pulito" della risposta ma potrebbe essere preceduto da una linea contentente (presumibilmente) la lunghezza in byte dell
 risposta.
...
proporzionale a un numero a 10 bit (0 - 1023). Per fare questo è possibile utilizzare la funzione map già presente nella libreria
standard di Arduino. \\
