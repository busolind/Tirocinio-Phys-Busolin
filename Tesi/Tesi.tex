...
\section{Termometri} \todo{busolin: Se anche uno strumento ha al suo interno un termometro di taratura, quasi sicuramente non sarà integrabile con l'ESP. Menziono lo stesso la possibilità di aggiungere un DHT?}
...
gamma di componenti esterne si presta molto bene all'incarico. \cite{esphomeio} \todo{busolin: Ora che questo discorso è anche nello stato dell'arte, questa è una ripetizione?}
