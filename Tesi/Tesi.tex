...
coincide con il fondoscala dello strumento di misura questo è sufficiente, altrimenti è necessario ridurre l'estremo superiore via software
o utilizzare un partitore di tensione o un potenziometro. Nel caso in cui la tensione in uscita massima del microcontrollore sia inferiore
ad ogni possibile fondoscala dello strumento di misura, questa soluzione non è attuabile. \\
 Lo svantaggio di questa soluzione è che il sistema non è contenuto in un unico oggetto ma ci sono componenti esterni.
...
strumento vero e proprio come se si fosse usato il selettore di modalità.
Se non si vuole rimpiazzare la resistenza interna valgono le stesse osservazioni fatte poc'anzi sui fondoscala: se non era presente
nessuna modalità con fondoscala adatto sarà necessario utilizzare una resistenza più piccola di quella/e già presente/i. \\ %Piccola?
...
ottenere un oggetto più pulito. Se si ha la facoltà di inserire una batteria diventa anche incredibilmente discreto e di più facile
posizionamento, anche dove è scomodo portare una fonte di alimentazione.

Ulteriori possibile modifiche meno banali includono l'aggiunta di elementi decorativi quali delle luci o funzionali quali bottoni o altoparlanti
per ampliare le possibilità di utilizzo. Un'altra possibilità di modifica ove possibile è la sostituzione dell'etichetta sotto all'ago
