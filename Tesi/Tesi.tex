...
Consentono di produrre dei suoni, un esempio di applicazione è nei tester di continuità elettrica, che emettono un suono alla rilevazione.
...
\subsection{Interruttori / Pulsanti}
Possono essere mappati a valori booleani (true/false). \todo{+ Collegamenti a GPIO}
...
\subsection{Potenziometri}
Possono essere mappati a valori aventi intervallo arbitrario, con una precisione limitata dalla risoluzione del convertitore analogico-digitale integrato nel microcontrollore.

\begin{circuitikz} \draw
(0,4) to[potentiometer, n=pot] (0,0)
  (0,4) to[short,-o] (4,4)
  to[twoport,t={ESP}, n=esp] (4,0)
  -- (0,0)
  (pot.wiper) -- (esp)
;
\end{circuitikz}
